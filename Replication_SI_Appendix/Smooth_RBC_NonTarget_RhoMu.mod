% =================================================================== %
%  This does the smoothing by fixing key estimated parameters to see how the
%  key dynamics implied by them change.
%
% =================================================================== %
// dynare RBC_NonTarget_RhoMu.mod
...
stoch_simul(periods=200, nograph) data_GDP data_cc data_ASind;
