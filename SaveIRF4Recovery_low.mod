% =================================================================== %
%  This computes the IRFs for the Recovery exercise with low mu.
%  
% =================================================================== %
...
% =================================================================== %
load('AsEstRBC_results.mat', 'oo_')

a_RHO_zc  = oo_.posterior_mean.parameters.RHO_zc     ;
a_RHO_zas = oo_.posterior_mean.parameters.RHO_zas   ; 
a_RHO_AS  = oo_.posterior_mean.parameters.RHO_AS     ; 
a_RHO_MU  = oo_.posterior_mean.parameters.RHO_MU   ; 
aa_mu  =  oo_.posterior_mean.parameters.mu; % Use double aa, not to confuse with a_{mu,t}.

a_adlag   = oo_.posterior_mean.parameters.adlag     ; 
a_STDERR_eps_g_as = oo_.posterior_mean.shocks_std.eps_g_as     ;
a_STDERR_eps_zc = oo_.posterior_mean.shocks_std.eps_zc  ;
a_STDERR_eps_zas  = oo_.posterior_mean.shocks_std.eps_zas  ;
a_STDERR_eps_mu  = oo_.posterior_mean.shocks_std.eps_mu   ;
a_STDERR_eps_gr  = oo_.posterior_mean.shocks_std.eps_gr   ;
...
set_param_value('mu', aa_mu*oo_.SmoothedVariables.Mean.a_mu(timedate)  );
...
var eps_g_as ;  stderr  STDERR_AS *11 ;
...
stoch_simul( order = 1, irf_shocks  = ( eps_g_as ), IRF = 156, nograph, noprint) g_as pas Yas Yc growthrate GDP_log Z; 

if higheffect == 0
    growthrate_eps_g_as_05 = growthrate_eps_g_as;
    GDP_log_eps_g_as05 =GDP_log_eps_g_as;
    g_as_g_as05 = g_as_eps_g_as;
    save('Results\irf05','growthrate_eps_g_as_05','GDP_log_eps_g_as05','g_as_g_as05')
elseif higheffect == 1
    growthrate_eps_g_as_75 = growthrate_eps_g_as;
    GDP_log_eps_g_as75 =GDP_log_eps_g_as;
    g_as_g_as75 = g_as_eps_g_as;
    save('Results\irf75','growthrate_eps_g_as_75','GDP_log_eps_g_as75','g_as_g_as75') 
end
