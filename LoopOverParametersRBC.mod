% =================================================================== %
%  This loops over the draws to estimate the credible IRFs to GDP.
% 
% =================================================================== %

// dynare LoopOverParametersRBC.mod
...
stoch_simul(  order = 1, irf_shocks  = ( eps_g_as ),  irf  = 80, nograph, noprint) g_as pas Yas Yc growthrate; 
...
for iii=1:size(parametri_loop,1)
    ...
    stoch_simul(  order = 1, irf_shocks  = ( eps_g_as ), irf   = 80, nograph, noprint) growthrate GDP_log;
    if info;
...
if higheffect == 1;
    save('Results\IRFS_confidence_1975','store_IRFs_growthrate','store_IRFs_GDP_log','dates','growthrate_ss','options_')
elseif higheffect == 0;
    save('Results\IRFS_confidence_2005','store_IRFs_growthrate','store_IRFs_GDP_log','dates','growthrate_ss','options_')
end    
