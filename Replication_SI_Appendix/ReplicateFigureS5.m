%----------------------------------------------------------------
% Plot the smoothed spillover over time from IT (Figure S5).
% 
%----------------------------------------------------------------
...
addpath('AsEstRBC_Rev_IT')

dates = 1960:0.25:2018.75;
load('AsEstRBC_Rev_IT_results.mat')

if ispc == 1
    load('AsEstRBC_Rev_IT\metropolis\AsEstRBC_Rev_IT_param1.mat', 'stock')
elseif ispc == 0
    load('AsEstRBC_Rev_IT/metropolis/AsEstRBC_Rev_IT_param1.mat', 'stock')
end
...
if ispc == 1
    load('AsEstRBC_Rev_IT\metropolis\AsEstRBC_Rev_IT_smooth1.mat', 'stock')
elseif ispc == 0
    load('AsEstRBC_Rev_IT/metropolis/AsEstRBC_Rev_IT_smooth1.mat', 'stock')
end
...
if ispc == 0
load('AsEstRBC_Rev_IT\metropolis\AsEstRBC_Rev_IT_smooth2.mat', 'stock')
elseif ispc == 1
load('AsEstRBC_Rev_IT/metropolis/AsEstRBC_Rev_IT_smooth2.mat', 'stock')
end
